...
func NewRefreshHandler(cfg *HandlersConfig) *RefreshHandler {
...
func (cfg *RefreshHandler) HandleRefresh(w http.ResponseWriter, r *http.Request) {
...
func (cfg *RefreshHandler) HandleRevoke(w http.ResponseWriter, r *http.Request) {
	refreshToken, err := auth.GetBearerToken(r.Header)
	if err != nil {
		respondWithError(w, http.StatusBadRequest, "Couldn't find JWT")
		return
